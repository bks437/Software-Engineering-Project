<?php
	...
	//$ht=pg_fetch_array($result6);


	
	//$header_table = "<table align='center' border='1px' width='400px'>";
	//$header_table .= "<tr align='center'><th><b>STUDENT INFORMATION</b></th></tr>";
